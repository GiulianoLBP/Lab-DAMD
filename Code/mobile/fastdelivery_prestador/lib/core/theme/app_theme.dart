...
/// coerentes. Cópia idêntica do tema do app cliente (decisão da Sprint 4 — apps
/// independentes com core copiado). Mantém o azul de marca (`0xFF2563EB`) e o
/// fundo claro já usados.
class AppTheme {
  const AppTheme._();
