...
///
/// O parsing é defensivo (nunca quebra a tela por JSON inesperado): campos
/// textuais ausentes viram string vazia. Um `id` ausente/ inválido é violação
/// de contrato, então lança [FormatException] em vez de produzir um modelo
/// inconsistente.
class Entrega {
  const Entrega({
    required this.id,
